...
const Hero = () => {
            ...
            <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
               ...
               {/*left side content*/}
                ...
                <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                    Hi,I'm <span className='text-purple-400'>Rutik Patil</span>
                    </h1>
  ...
  <a href='#contact' className='px-6 py-3 border border-purple-600 text-purple-600 rounded-lg font-medium hover:bg-purple-600/20 transition duration-300' >Contact Me</a>
</div>
    </div>
    {/*Right side image*/}
    ...
    <div className='relative w-64 h-64 md:w-80 md:h-80'>
        <div className='basolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink  opacity-70'>
            ...
            className='relative rounded-full w-64 h-64 md:w-80 md:h-110 object-cover z-10 animate-float'
